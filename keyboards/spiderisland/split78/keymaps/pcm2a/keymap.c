...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAME] = LAYOUT(
        ...
        _______, _______, KC_O,    _______, _______, _______, _______, KC_R,    KC_E,    KC_W,    KC_Q,    KC_TAB,  KC_M,    _______,
        _______, _______, _______, _______, _______, _______, KC_G,    KC_F,    KC_A,    KC_S,    _______, KC_D,             _______,
