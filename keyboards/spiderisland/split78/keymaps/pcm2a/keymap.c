...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAME] = LAYOUT(
        ...
        _______, _______, KC_O,    _______, _______, _______, _______, KC_R,    KC_E,    KC_W,    _______, KC_TAB,  _______, _______,
        _______, _______, _______, _______, _______, _______, _______, KC_F,    KC_A,    KC_S,    _______, KC_D,             _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, KC_LCTL, KC_LSFT, KC_LCTL,    _______,
        _______, _______, _______, _______,          _______,          _______,          _______, KC_Z, KC_X, KC_C,    KC_V
    )
};
